...
<div class="container-fluid mb-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 m-auto">
            <form action="test_desc_insert.php" method="POST" id="card">
                <div class="card position-relative shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <textarea name="test_desc" id="card_desc" cols="10" rows="5" class="form-control" placeholder="write something for card description... "></textarea>
