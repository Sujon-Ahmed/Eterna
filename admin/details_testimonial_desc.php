...
<div class="container-fluid mb-5">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-1 text-gray-800">testimonial Description</h1>
    <p class="mb-4">Dashboard / View / testimonial Details</p>
        ...
        <div class="card shadow mb-5">
            <div class="card-header py-3">
                <div class="d-flex justify-content-lg-between">
                    ...
                    <div><a href="view_test_desc.php?id=<?php echo $_GET['id']; ?>" class="btn btn-primary btn-sm">View</a></div>
                </div>
